...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 20, 361, 481))
        ...
        self.tableViewTop3Merits.setGeometry(QtCore.QRect(80, 30, 271, 192))
        self.tableViewTop3Merits.setObjectName(_fromUtf8("tableViewTop3Merits"))
        self.tableViewTop3Demerits = QtGui.QTableView(self.groupBox)
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(370, 20, 381, 501))
        ...
        self.tableViewTop3Marks = QtGui.QTableView(self.groupBox_2)
        self.tableViewTop3Marks.setGeometry(QtCore.QRect(90, 30, 281, 211))
        self.tableViewTop3Marks.setObjectName(_fromUtf8("tableViewTop3Marks"))
        self.tableViewBot3Marks = QtGui.QTableView(self.groupBox_2)
        self.tableViewBot3Marks.setGeometry(QtCore.QRect(90, 290, 281, 211))
        ...
        self.btnEditStudentBehaviour = QtGui.QPushButton(self.tab_2)
        self.btnEditStudentBehaviour.setGeometry(QtCore.QRect(380, 470, 131, 23))
        self.btnEditStudentBehaviour.setObjectName(_fromUtf8("btnEditStudentBehaviour"))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btnEditStudentBehaviour.setText(_translate("MainWindow", "Edit Merits and Demerits", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Students", None))
        self.menu_File.setTitle(_translate("MainWindow", "&File", None))
        self.actionExit_Application.setText(_translate("MainWindow", "E&xit Application", None))
